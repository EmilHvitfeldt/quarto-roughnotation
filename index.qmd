...
[View Example](example.html){.btn .btn-primary}
[Source Code](https://github.com/EmilHvitfeldt/quarto-roughnotation/blob/main/example.qmd){.btn .btn-secondary}

<iframe src="example.html" width="100%" height="500" style="border: 1px solid #ccc; border-radius: 4px;"></iframe>
...
[View Example](example-flourish.html){.btn .btn-primary}
[Source Code](https://github.com/EmilHvitfeldt/quarto-roughnotation/blob/main/example-flourish.qmd){.btn .btn-secondary}

<iframe src="example-flourish.html" width="100%" height="500" style="border: 1px solid #ccc; border-radius: 4px;"></iframe>
